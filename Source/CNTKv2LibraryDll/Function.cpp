...
namespace CNTK
{
    /*static*/ UserFunctionFactoryPtr Function::m_userFunctionFactory = std::make_shared<UserFunctionFactory>();
    ...
    {
        m_userFunctionFactory->Register(uniqueOpName, moduleName, factoryMethodName);
    }
    ...
    {
        return AsComposite(m_userFunctionFactory->CreateInstance(opName, operands, functionConfig, userFunctionInstanceName), userFunctionInstanceName);
    }
